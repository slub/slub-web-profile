...
class MessageService
{
     ...
     */
    public function getMessagesForUser(array $user): ?array
    {
        // Update the path for the api call because we need the user category in uri
        $this->apiConfiguration->updatePaths($user);

        $uri = $this->apiConfiguration->getMessageListUri();
